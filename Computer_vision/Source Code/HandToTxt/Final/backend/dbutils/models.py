...
class Manager(Base):
    """
    Database model for managing hand gesture analysis requests
    """
    __tablename__ = "hndtotxt_manager"
    ...
    result = Column(JSON, nullable=True)  # Store hand gesture results as JSON
